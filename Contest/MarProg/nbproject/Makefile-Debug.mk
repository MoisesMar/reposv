...
${OBJECTDIR}/Noldbach.o: Noldbach.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Noldbach.o Noldbach.cpp
...
${OBJECTDIR}/VarelaAndPlates.o: VarelaAndPlates.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VarelaAndPlates.o VarelaAndPlates.cpp
...
${OBJECTDIR}/nbproject/Games.o: nbproject/Games.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbproject/Games.o nbproject/Games.cpp
